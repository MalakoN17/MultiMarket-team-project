              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 mx-10 text-center items-center sm:mt-0 sm:ml-4 sm:text-center">
                    ...
                    <div className="mt-2">
                      <select value={city} onChange={handleCitySelect} name="cars" id="cars">
                        <option value="volvo">ירושלים </option>
                        <option value="saab">תל אביב</option>
                        <option value="mercedes">חיפה</option>
                        <option value="audi">נתניה</option>
                      </select>
                    </div>
                  </div>
                </div>
